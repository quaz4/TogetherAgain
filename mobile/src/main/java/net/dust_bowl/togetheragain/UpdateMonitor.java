...
public class UpdateMonitor extends IntentService
{
    ...
    private static final String EXTRA_PARAM1 = "net.dust_bowl.togetheragain.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "net.dust_bowl.togetheragain.extra.PARAM2";
